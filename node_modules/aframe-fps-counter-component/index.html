...
<html>
  <head>
    <meta charset="utf-8">
    <title>A-Frame FPS Counter Component</title>
    <meta name="description" content="A simple FPS counter component to measure performance in VR for A-Frame."></meta>
    <style>
      html {
        background: #33425B;
        color: #FAFAFA;
  ...
  <body>
    <h1>A-Frame FPS Counter Component</h1>
